...
const Privacy = () => {
  return (
    <Container className="container">
      ...
      <p>
        <b>13.1</b> Стоимость услуг определяется, в соответствии с Программой
        обучения, в зависимости от выбранного Заказчиком курса.
      </p>
      <p>
        <b>13.2</b>
        Стоимость Услуги указывает для 1 (одного) участника (физического лица
        или сотрудника юридического лица).
      </p>
      <p>
        <b>13.3</b>
        Заказчик производит оплату стоимости Услуг путём 100% предоплаты
        единовременно путём перечисления денежных средств на расчётные счёт
        Aipply academy, если иные условия не указаны в выставляемом Заказчику
        счёте.
      </p>
      <p>
        <b>13.4</b>
        Оплата Услуг осуществляется Заказчиком в пользу Aipply academy путем
        перечисления соответствующей суммы денежных средств способами,
        поддерживаемыми Aipply academy. При этом Aipply academy вправе
        самостоятельно определять перечень таких способов, доводя до Заказчика
        актуальный перечень способов путём размещения его Сайте, либо информируя
        Заказчика электронным сообщением или иным способом.
      </p>
      <p>
        <b>13.5</b>
      ...
      <p>
        <b>13.6</b>
        Сумма оплаты по выбранному курсу включает все расходы, связанные с
        оказанием услуг, включая раздаточный материал.
      </p>
      <p>
        <b>13.7</b>
        Aipply academy вправе в одностороннем порядке изменить стоимость
        оказываемых услуг. При этом изменение стоимости Услуг в отношении уже
        оплаченного Заказчиком Курса не производится.
      </p>
    </Container>
  );
};
