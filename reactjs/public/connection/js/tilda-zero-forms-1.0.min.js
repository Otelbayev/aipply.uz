...
function t_zeroForms__createForm(t, e, r, o) {
  ...
  u.classList.add("js-successbox"),
    u.classList.add("t-form__successbox"),
    u.classList.add("t-text"),
    u.classList.add("t-text_sm"),
    (u.style.display = "none"),
    (u.innerHTML = n.formmsgsuccess),
  ...
  if (f) {
    ...
    (g.style.textAlign = "center" === n.buttonalign ? "center" : "left"),
      (g.style.color = m.color),
      (g.style.fontWeight = m.fontWeight),
  ...
  if (n.fieldfontfamily) {
    ...
    t_zeroForms__setScriptOrStyle(
      ...
      (w = w.reduce(function (t, e, r) {
        return (
          (t += h + ".t-input-block " + e), r !== w.length - 1 && (t += ", "), t
        );
      }, "")) +
        ' {font-family: "' +
        n.fieldfontfamily +
    ...
    window.addEventListener(S, function () {
      k ||
        (k = setTimeout(function () {
          t_zeroForms__updateCurrentResolution(t, L),
  ...
  switch ((p.classList.add("t-input-block"), r.li_type)) {
    ...
    case "rd":
      ...
      t_zeroForms__setScriptOrStyle(
        ...
        "",
        (z += "fieldset {padding: 0; margin: 0; border: none;}"),
        "style",
        e
      ),
        "checkbox" === y &&
  ...
  return (
    n.forEach(function (r, o) {
      var n = document.createElement("option"),
        ...
        _ = a.label,
        c = a.calcValue;
      c && t396_zeroForms__setCalcValue(n, c),
        (n.value = _),
        (n.textContent = _),
...
function t_zeroForms__createCheckbox(t, e, r, o) {
  ...
  var l = t396_zeroForms__prepareCalcValue(t, t.li_label),
    ...
    c = l.calcValue;
  return (
    c && t396_zeroForms__setCalcValue(i, c),
    (s.innerHTML = _),
